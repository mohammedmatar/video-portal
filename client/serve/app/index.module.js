...
/***/ function(module, exports) {
	...
	var MainController = exports.MainController = function () {
	  ...
	  function MainController($timeout, webDevTec, toastr) {
	    ...
	    this.awesomeThings = [];
	    this.classAnimation = '';
	    this.creationDate = 1466648981692;
	    this.toastr = toastr;
